...
pub struct AlignedBuffer {
    ...
    _data: ScreenTransformation<f32>,
...
impl AlignedBuffer {
    ...
    pub const PAD: usize =
        Self::ALIGNMENT as usize - std::mem::size_of::<ScreenTransformation<f32>>();

    pub fn new(data: ScreenTransformation<f32>) -> Self {
        Self {
            _data: data,
...
impl TransformBuffer {
    pub fn new(
        ...
        transforms: &[ScreenTransformation<f32>],
        dev: &Device,
    ) -> Self {
    ...
    pub fn with_capacity(cap: usize, layout: &BindingGroupLayout, dev: &Device) -> Self {
        let aligned = AlignedBuffer::new(ScreenTransformation::identity());
    ...
    fn aligned(transforms: &[ScreenTransformation<f32>]) -> Vec<AlignedBuffer> {
